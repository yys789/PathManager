...
public:
    ...
    QPushButton *pushButton_circleFit;
    QMenuBar *menubar;
    ...
    void setupUi(QMainWindow *MainWindow2)
    {
        ...
        pushButton_fit = new QPushButton(centralwidget);
        pushButton_fit->setObjectName(QStringLiteral("pushButton_fit"));
        pushButton_fit->setGeometry(QRect(310, 440, 79, 40));
        pushButton_fit->setMinimumSize(QSize(0, 40));
        pushButton_circleFit = new QPushButton(centralwidget);
        pushButton_circleFit->setObjectName(QStringLiteral("pushButton_circleFit"));
        pushButton_circleFit->setGeometry(QRect(430, 440, 79, 40));
        pushButton_circleFit->setMinimumSize(QSize(0, 40));
        ...
        radioButton_2->raise();
        radioButton_3->raise();
        pushButton_fit->raise();
        pushButton_circleFit->raise();
    ...
    void retranslateUi(QMainWindow *MainWindow2)
    {
        ...
        pushButton_fit->setText(QApplication::translate("MainWindow2", "\346\213\237\345\220\210", 0));
        pushButton_circleFit->setText(QApplication::translate("MainWindow2", "\345\234\206\346\213\237\345\220\210", 0));
    } // retranslateUi
